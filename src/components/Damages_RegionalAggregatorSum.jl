...
@defcomp Damages_RegionAggregatorSum begin
    ...
    damage_bressler_mortality = Parameter(index=[time,ag_mapping_input_regions], unit="US\$2005/yr")
    ...
    damage_bressler_mortality_regions = Variable(index=[time,ag_mapping_output_regions], unit="US\$2005/yr")
    ...
    function run_timestep(p,v,d,t)
        ...
        v.damage_bressler_mortality_regions[t, :] .= 0.
        ...
        for i in d.ag_mapping_input_regions
            ...
            v.damage_bressler_mortality_regions[t, v.input_output_mapping_int[i]] += p.damage_bressler_mortality[t,i]
